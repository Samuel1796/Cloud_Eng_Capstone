...
│  VPC (10.0.0.0/16)                                          │
│                                                             │
│  Public Subnets (AZ-1 & AZ-2) [Green]                      │
│  ┌──────────────────────────────────────────────────────┐   │
│  │  Application Load Balancer          NAT Gateway x2   │   │
│  └───────────────────┬──────────────────────────────────┘   │
│                      │                                      │
│  EC2 Auto Scaling Group (Web/App) — spans both public subs  │
│                      │                                      │
│  Private Subnets (AZ-1 & AZ-2) [Red]                       │
│  ┌──────────────────────────────────────────────────────┐   │
...
│                                                             │
│  Security & Operations Layer                                │
│  CloudWatch  │  CloudTrail  │  GuardDuty  │  KMS           │
└─────────────────────────────────────────────────────────────┘
  │
  ▼ Backups
┌─────────────────────┐
...
*Prepared as part of the AWS Well-Architected and Cloud Adoption Framework Lab.*
